...
data= np.genfromtxt(
    r"C:\Users\user\Documents\GitHub\MY-AI-COURSE\MY-AI-COURSE\03_python_Projects\RealEstate-USA (1).csv",
    delimiter=",",
    usecols=(2, 3, 4, 9),
    skip_header=1,
    unpack=True
...
import numpy as np 
df=np.genfromtxt(r"C:\Users\user\Documents\GitHub\MY-AI-COURSE\MY-AI-COURSE\03_python_Projects\RealEstate-USA (1).csv",
